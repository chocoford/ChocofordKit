...
//  Copied from https://github.com/fredyshox/PageView/blob/master/Sources/PageViewBuilder.swift

import SwiftUI

struct PagesCountKey: PreferenceKey {
...
//    }
    ...
    public var body: some View {
        content
            .preference(key: PagesCountKey.self, value: count)
    }
}
